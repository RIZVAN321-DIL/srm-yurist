...
# =============================================
# CRM Yurist v6.3.1 — ЧАСТЬ 1/3
# Инфраструктура, config, security, модели
# =============================================

# Очистка и создание структуры
rm -rf app
mkdir -p app/core app/models app/repositories app/api/routes app/api/schemas app/static/uploads app/static/js/modules app/data
...
echo ""
echo "=============================================="
echo "  ЧАСТЬ 1/3 ГОТОВА"
echo "  Можно запускать часть 2"
echo "=============================================="#!/bin/bash

# =============================================
# CRM Yurist v6.3.1 — ЧАСТЬ 2/3
# Схемы Pydantic и Репозитории
# =============================================
...
echo ""
echo "=============================================="
echo "  ЧАСТЬ 2/3 ГОТОВА"
echo "  Можно запускать часть 3"
echo "=============================================="#!/bin/bash

# =============================================
# CRM Yurist v6.3.1 — ЧАСТЬ 3/3
# Роуты API и Статика (HTML/JS)
# =============================================
...
cat > app/static/js/modules/dashboard.js << 'EOF'
...
echo ""
echo "=============================================="
echo "  ВСЕ 3 ЧАСТИ ГОТОВЫ"
echo "  CRM v6.3.1 — можно запускать!"
echo ""
echo "  Локально:  uvicorn app.main:app --host 0.0.0.0 --port 10000"
echo "  Админ:     http://localhost:10000/admin"
echo "  Логин:     admin"
